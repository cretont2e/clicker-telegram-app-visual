                ...
                <div className="flex-grow mt-4 bg-[#f3ba2f] rounded-t-[48px] relative top-glow z-0">
                    <div className="mt-[2px] bg-[#1d2025] rounded-t-[46px] h-full overflow-y-auto no-scrollbar">
                        <div className="px-4 pt-1 pb-24">
                            <h1 className="text-2xl text-center mt-4">Upgrade Runa Production</h1>
                            ...
                            <div className="bg-[#272a2f] rounded-lg p-4 mt-6 flex items-start">
                                ...
                                <p className="text-sm text-gray-300">
                                    Your mine automatically produces runa for up to <span className="text-white font-bold">{maxInactiveHours} hours</span> after your last activity. Make sure to check in regularly to maximize your runa production!
                                </p>
                            </div>
